...
def train_full_nerf(base_dir, logger_name, steps, pos_enc, direc_enc, use_gpu,
                    num_rays, width, height, coarse_samples, fine_samples, args): 
    ...
    train_dl = dataloader.getSyntheticDataloader(base_dir, 'train', num_rays, width, height, 
                                                 num_workers=8, shuffle=True)
    val_dl = dataloader.getSyntheticDataloader(base_dir, 'val', num_rays, width, height, 
...
if __name__ == '__main__': 
    ...
    full_parser.add_argument('-t', '--height', type=int, default=800, help='height of images')
    full_parser.add_argument('-w', '--width', type=int, default=800, help='width of images')
    ...
    if args.type == 'simple': 
        ...
        #                 args.gpu, args.rays, args.width, args.height, args.coarse, args.fine, args)